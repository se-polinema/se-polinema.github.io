...
photoPosition: "50% 18%"
shortBio:
  id: "Peneliti dengan fokus pada analisis sentimen, sistem terdistribusi, chatbot, dan evaluasi pembelajaran pemrograman web."
  en: "Researcher focused on sentiment analysis, distributed systems, chatbots, and web-programming assessment systems."
profileBody:
  id: "Dian Hanifudin Subhi mengembangkan sistem terapan yang menggabungkan rekayasa perangkat lunak, analitik, dan otomasi. Risetnya mencakup analisis sentimen umpan balik publik, model interaksi terdistribusi, penilaian pendidikan untuk pemrograman web, dan sistem pendukung operasional seperti chatbot. Profil ini memperkuat fokus perangkat lunak terapan laboratorium, terutama ketika kualitas rekayasa bertemu dengan lingkungan layanan dan pembelajaran nyata."
  en: "Dian Hanifudin Subhi develops applied systems that combine software engineering, analytics, and automation. His research spans public-feedback sentiment analysis, distributed interaction models, educational assessment for web programming, and operational support systems such as chatbots. This profile reinforces the laboratory's applied-software focus, especially where engineering quality meets real service and learning environments."
expertise:
  - "Distributed Systems"
  - "Sentiment Analysis"
  - "Chatbots"
...
researchInterests:
  id:
    - "Analisis sentimen komentar layanan publik"
    - "Model publish-subscribe adaptif"
    - "Penilaian otomatis pemrograman web"
  en:
