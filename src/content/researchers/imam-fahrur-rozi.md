...
profileBody:
  id: "Imam Fahrur Rozi berkontribusi pada riset terapan laboratorium di bidang teknologi bahasa dan sistem informasi cerdas. Rekam publikasinya menonjolkan analisis sentimen berbahasa Indonesia, deteksi misinformasi, optical character recognition, dan pemodelan sistem rekomendasi. Karyanya memperkuat orientasi laboratorium pada persoalan rekayasa perangkat lunak yang menggabungkan pemrosesan data, evaluasi algoritma, dan sistem analitik yang dapat diterapkan dalam konteks publik maupun institusional."
  en: "Imam Fahrur Rozi contributes to the laboratory's applied research in language technology and intelligent information systems. His publication record emphasizes sentiment analysis in Indonesian, misinformation detection, optical character recognition, and recommender-system modeling. His work strengthens the laboratory's orientation toward software engineering problems that combine data processing, algorithm evaluation, and deployable analytical systems for public and institutional use."
expertise:
