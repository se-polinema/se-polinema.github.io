...
shortBio:
  ...
  en: "Researcher focused on sentiment analysis, natural language processing, and cross-domain recommender systems."
profileBody:
  id: "Imam Fahrur Rozi berkontribusi pada riset terapan laboratorium di bidang teknologi bahasa dan sistem informasi cerdas. Rekam publikasinya menonjolkan analisis sentimen berbahasa Indonesia, deteksi misinformasi, optical character recognition, sistem chatbot berbasis NLP, dan pemodelan sistem rekomendasi. Ia juga mengarahkan riset ke depan pada penerapan NLP untuk rekayasa perangkat lunak dan otomasi alur kerja berbasis agentic AI. Karyanya memperkuat orientasi laboratorium pada persoalan rekayasa perangkat lunak yang menggabungkan pemrosesan data, evaluasi algoritma, dan sistem analitik yang dapat diterapkan dalam konteks publik maupun institusional."
  en: "Imam Fahrur Rozi contributes to the laboratory's applied research in language technology and intelligent information systems. His publication record emphasizes sentiment analysis in Indonesian, misinformation detection, optical character recognition, NLP-based chatbot systems, and recommender-system modeling. He is also directing his research forward toward NLP applied to software engineering and agentic AI-based workflow automation. His work strengthens the laboratory's orientation toward software engineering problems that combine data processing, algorithm evaluation, and deployable analytical systems for public and institutional use."
expertise:
...
researchInterests:
  id:
    ...
    - "OCR dan analisis dokumen"
    - "NLP untuk artefak rekayasa perangkat lunak"
    - "Otomasi alur kerja agentic untuk tugas rekayasa perangkat lunak"
  en:
    - "Indonesian-language sentiment analysis"
    - "Fake news detection"
    - "OCR and document analysis"
    - "NLP applied to software engineering artifacts"
    - "Agentic workflow automation for software engineering tasks"
...
books:
  ...
  - title: "Mengenal Algoritma dan Struktur Data dengan Panduan Praktis"
    ...
    description: "A practical guide to fundamental algorithms and data structures including arrays, stacks, queues, and linked lists. Designed for beginners to intermediate learners with clear step-by-step explanations, practical examples, and exercises that build strong programming foundations."
    descriptionId: "Buku ini dirancang untuk membantu pembaca memahami konsep dasar algoritma dan struktur data dengan cara yang praktis dan mudah diikuti. Setiap topik dijelaskan dengan langkah-langkah yang jelas, disertai contoh-contoh praktis dan studi kasus yang relevan. Sangat cocok bagi siapa saja yang ingin mendalami pemrograman dengan fondasi yang kuat dalam algoritma dan struktur data."
---
