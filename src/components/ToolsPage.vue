          ...
          >
            ...
            <div class="flex flex-wrap items-center gap-3 text-xs">
              <a
                ...
                target="_blank"
                rel="noopener"
                class="inline-flex items-center gap-1 font-mono text-accent dark:text-yellow-300 hover:underline transition-colors"
              >
            ...
            <div class="flex flex-wrap items-center gap-x-4 gap-y-1 pt-1 border-t border-primary/5 dark:border-gray-700">
              <div v-if="tool.researchers.length > 0" class="flex flex-wrap items-center gap-1.5 text-[11px] text-neutral-500 dark:text-gray-400">
                ...
                <a
                  ...
                  class="text-accent dark:text-yellow-300 hover:underline"
                >{{ researcherName(rid) }}</a>
              </div>
              <a
                v-if="tool.publicationSlug"
                :href="`/publications/${tool.publicationSlug}`"
                class="inline-flex items-center gap-1 text-[11px] font-mono text-accent dark:text-yellow-300 hover:underline transition-colors"
